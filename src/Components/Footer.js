...
import FSSAI from '../img/Fssai-Logo-Vector-removebg-preview.png'

const Footer = () => {
    return (
        <div className='min-w-screen bottom-0 pt-[60px] justify-between bg-[#0c111a]'>
            <div className='min-h-[240px] max-w-full gap-[20px] grid grid-cols-1 sm:grid-cols-3'>
                ...
                <div className='flex flex-col items-center'>
                    <div className=' items-center justify-center max-w-full'>
                        <p className='m-2 p-4 md:p-1 text-white text-xl leading-8'>
                            SURUKUPAI FOODS,<br />
                ...
                <div className='flex flex-col items-center justify-center'>
                    <div className='m-4 justify-center'>
                        ...
                        <div className='flex items-center justify-center gap-[20px]'>
                            <a target='_blank' href="https://www.linkedin.com/company/surukupai-foods">
                            ...
                            <a target="_blank" href="https://instagram.com/surukupaifoods?utm_medium=copy_link">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48">
                            ...
                            <a target="_blank" href="https://maps.app.goo.gl/w7Q5RYFN3tx74Bb3A">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48">
